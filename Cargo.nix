  ...
  internal = rec {
    ...
    crates = {
      ...
      "kakuremino" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "i2p" "nym" "shadowsocks" "tor" ];
      };
      "keccak" = rec {
        crateName = "keccak";
        version = "0.1.6";
      ...
      "regex-automata" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "dfa-build" "dfa-search" "meta" "nfa-pikevm" "nfa-thompson" "std" "syntax" "unicode-case" ];
      };
      "regex-syntax" = rec {
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "io-util" "libc" "macros" "mio" "net" "process" "rt" "rt-multi-thread" "signal-hook-registry" "socket2" "sync" "test-util" "time" "tokio-macros" "windows-sys" ];
      };
      "tokio-macros" = rec {
